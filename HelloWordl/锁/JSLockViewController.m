...
@interface JSLockViewController ()

@end

@implementation JSLockViewController
...
- (void)viewDidLoad {
    ...
    UIButton *clear = [[UIButton alloc]initWithFrame:CGRectMake(80, 450, 100, 44)];
    [clear addTarget:self action:@selector(clearAction:) forControlEvents:UIControlEventTouchUpInside];
    clear.backgroundColor = [UIColor greenColor];
    [clear setTitle:@"clear sum" forState:UIControlStateNormal];
